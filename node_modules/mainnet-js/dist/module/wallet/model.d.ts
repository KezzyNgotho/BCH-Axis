...
export type SendRequestType = SendRequest | TokenSendRequest | OpReturnData | Array<SendRequest | TokenSendRequest | OpReturnData> | SendRequestArray[];
...
export declare class OpReturnData {
     ...
     */
    static from(data: string | Uint8Array): OpReturnData;
    /**
     ...
     * @returns class instance
     */
    static fromArray(array: Array<string | Uint8Array>): OpReturnData;
    /**
