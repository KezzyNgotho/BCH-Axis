import { decodeHdPublicKey, encodeCashAddress, binToHex, CashAddressType, deriveHdPathRelative, } from "@bitauth/libauth";
...
export function derivePublicNodeCashaddr(xpub, path) {
    const publicParent = decodeHdPublicKey(xpub);
    if (typeof publicParent === "string") {
        throw new Error(publicParent);
    }
    const prefix = (publicParent.network === "mainnet" ? "bitcoincash" : "bchtest");
    let cashaddr;
