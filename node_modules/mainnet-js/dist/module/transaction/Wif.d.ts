...
export declare function buildP2pkhNonHdTransaction({ inputs, outputs, signingKey, sourceAddress, fee, discardChange, feePaidBy, changeAddress, }: {
    inputs: UtxoI[];
    ...
    transaction: import("@bitauth/libauth").TransactionCommon<import("@bitauth/libauth").Input<Uint8Array, Uint8Array>, Output<Uint8Array, Uint8Array, bigint>>;
    sourceOutputs: any[];
}>;
 ...
 */
export declare function prepareOutputs(outputs: Array<SendRequest | TokenSendRequest | OpReturnData>): Promise<Output[]>;
/**
...
export declare function getFeeAmountSimple({ utxos, sendRequests, relayFeePerByteInSatoshi, discardChange, }: {
    utxos: UtxoI[];
...
export declare function getFeeAmount({ utxos, sendRequests, privateKey, sourceAddress, relayFeePerByteInSatoshi, feePaidBy, discardChange, }: {
    utxos: UtxoI[];
    sendRequests: Array<SendRequest | TokenSendRequest | OpReturnData>;
    privateKey: Uint8Array;
    sourceAddress: string;
...
export declare function buildEncodedTransaction({ inputs, outputs, signingKey, sourceAddress, fee, discardChange, feePaidBy, changeAddress, buildUnsigned, }: {
    inputs: UtxoI[];
    outputs: Array<SendRequest | TokenSendRequest | OpReturnData>;
    signingKey: Uint8Array;
    sourceAddress: string;
